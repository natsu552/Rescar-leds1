  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        {/* 🔥 BOTÃO ORIGINAL (SEM ESTOQUE) */}
        <button
          onClick={handleAddToCart}
          className="w-full py-3 rounded-lg font-bold flex items-center justify-center space-x-2 transition-all duration-300 bg-[#FF6B00] hover:bg-[#FF8C00] text-white hover:glow-orange-strong"
        >
